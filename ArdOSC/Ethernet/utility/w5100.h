...
public:
  // SSIZE must match TMSRVAL and RSIZE must match RMSRVAL
  // 1024 / 0x00, 2048 / 0x55, 4096 / 0xAA, 8096 / 0xFF
  // static const uint16_t SSIZE = 2048;	// Max Tx buffer size
  // static const uint8_t TMSRVAL= 0x55;	// Needs to match SSIZE (
  // static const uint16_t RSIZE = 2048;	// Max Rx buffer size
  // static const uint8_t RMSRVAL= 0x55;	// Needs to match RSIZE

  static const uint16_t SSIZE = 4096;	// Max Tx buffer size
  static const uint8_t TMSRVAL= 0xAA;	// Needs to match SSIZE (
  static const uint16_t RSIZE = 4096;	// Max Rx buffer size
  static const uint8_t RMSRVAL= 0xAA;	// Needs to match RSIZE
